...
nes - A template system for the Web
...
=head2 Sample a Nes Perl script
...
created previously.
    ...
    use Nes;
  = Nes::Singleton Nes::Singleton->new('template.nhtml'); # returns a new instan= Nes::Singletonnes = Nes::Singleton->new('other.nhtml');    # returns same i= Nes::Singleton    $nes = Nes::Singleton->new();                 # returns same instance
